...
- Covers file placement, block/element/modifier naming, nest elements, namespacing prefixes, selector complexity limits, external & legacy DOM handling, util classes, flexbox conventions, desktop-first media queries, and Less pitfalls.
