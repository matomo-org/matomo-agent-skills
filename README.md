...
- Covers file placement, block/element/modifier naming, nest elements, namespacing prefixes, selector complexity limits, util classes, desktop-first media queries, and Less pitfalls.
- Use when authoring or reviewing `.less`/`.css` files next to Vue components.
